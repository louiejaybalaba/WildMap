...
public class MainAdapter1 extends BaseExpandableListAdapter
{
    Context context;
    List<String> listGroup;
    HashMap<String, List<String>> listItem;

    public MainAdapter1(Context context, List<String> listGroup, HashMap<String, List<String>> listItem)
    {
